...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhongxy/FSMeeting_ios'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhongxy' => 'zhongxy@hst.com' }
  s.source           = { :git => 'https://github.com/zhongxy/FSMeeting_ios.git', :tag => s.version.to_s }
