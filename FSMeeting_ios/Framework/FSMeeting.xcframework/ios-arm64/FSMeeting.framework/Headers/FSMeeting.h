...
/// 男性发言者图片Url
@property (nonatomic, copy) NSString *maleSpeakerImageUrl;
/// 女性发言者图片Url
@property (nonatomic, copy) NSString *femaleSpeakerImageUrl;
/// 男性静音图片Url
@property (nonatomic, copy) NSString *maleMuteImageUrl;
/// 女性静音图片Url
@property (nonatomic, copy) NSString *femaleMuteImageUrl;
/// 被呼叫用户昵称
...
///   - text: 提示内容
///   - duration: 持续时间
- (void)showMinimizeButtonTip:(NSString *)text duration:(NSInteger)duration;
@end
